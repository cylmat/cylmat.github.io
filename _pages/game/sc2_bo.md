...
| 16 | Barracks |
| 17 | Refinery |
| 19 | Orbital + Supply Depot || 20 | Barracks Reactor (ou Tech Lab) |
| **26** | Factory |
| 30 | Refinery 2 + Starport |
| **40** | Factory Tech Lab ; 1-1-1 posé (produis Marines/Cyclones/Vikings ou drops) |
| 44+ | Command Center (expansion) ; transition bio ou mech selon ennemi |
...
| 18 | Extracteur (gaz) |
| 19 | Spawning Pool |
| **40** | Metabolic Boost sur Zerglings (speed) ; 4 Queens pour défense |
| 44 | Roach Warren ; 2e Hatchery |
| 60+ | Produis Roaches/Zerglings ; expansion 3e base ; Lair si besoin |

**Astuces** : Toujours 3 drones/gaz.Inject larves toutes les 12s. Creep spread avec Queens. 
